...
export default function FAQPage() {
  const faqs: FAQ[] = [
    {
      ...
      answer:
        "نظام متكامل لإدارة المدارس يشمل حضور وغياب، جداول دراسية، تقارير أداء، ورسائل.",
    },
    {
      question: "هل يمكن استخدام النظام على الهاتف؟",
      answer:
        "نعم، يمكن استخدام النظام على الهاتف من خلال المتصفح أو تطبيق مخصص.",
    },
    {
      question: "هل البيانات آمنة داخل النظام؟",
      answer:
        "نعم، البيانات مؤمنة باستخدام بروتوكولات حماية متقدمة لضمان السرية.",
    },
    {
      question: "هل يمكن متابعة الحضور والغياب للطلاب؟",
      answer:
        "نعم، يوفر النظام أدوات متابعة حضور الطلاب وإصدار تقارير يومية أو دورية.",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex justify-end ">
      <div className="max-w-4xl w-full space-y-6 text-right m-7">
        {faqs.map((faq, idx) => (
